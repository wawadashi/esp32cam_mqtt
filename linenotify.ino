...
const char* ssid     = "Dashi";   //your network SSID
const char* password = "0901236727";   //your network password

String lineNotifyToken = "iDIQBRyQ0MabqlsuN1cliymWmcxNmqqpPQuZSEWbrDu";    //Line Notify Token
...
{
  Serial.println(sendCapturedImage2LineNotify(lineNotifyToken));
  delay(1000*60*5);  //You could only send up to 50 images to Line Notify in one hour.
}
